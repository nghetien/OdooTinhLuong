...
class Major(models.Model):
    ...
    time_open = fields.Date(string='Thời gian mở mgành', required=True, help="Start date",
    ...
    def create(self, vals):
        ...
        # print('************************************************')
        # print(self.env['ir.sequence'].next_by_code('department.major.sequence') or _('New'))
        # print('************************************************')
